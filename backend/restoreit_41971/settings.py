"""
Django settings for restoreit_41971 project.
...
ROOT_URLCONF = 'restoreit_41971.urls'
...
WSGI_APPLICATION = 'restoreit_41971.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restoreit_41971 API",
    "DESCRIPTION": "API documentation for restoreit_41971 App",
    "VERSION": "v1",
}
